...
We'll go into more detail about `purr::map()` [shortly](#map-functions), but for now, imagine we have a **vector** of numbers, and we want to add `5` to each value before and multiplying by `10`.
