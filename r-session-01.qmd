...
Plot.plot({
  ...
  marks: [
    area ?
      ...
      [
        Plot.ruleY(eq_vals, {y: "Fraction", stroke: "State", strokeWidth: 2, strokeDasharray: [10]}),
        Plot.lineY(sir_demographic_sol_long, {x: "t", y: "Fraction", stroke: "State", strokeWidth: 6})
      ]
  ]
})
```
